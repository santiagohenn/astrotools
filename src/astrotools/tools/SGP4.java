...
public class SGP4 extends Propagator{
    ...
    public ElsetRec satrec = new ElsetRec();
     ...
     */
    public SGP4(SatElset satElset) throws SatElsetException, ObjectDecayed {
        twoline2rv(satElset);
    }
    ...
    private void initl(int satn, double ecco, double epoch, double inclo) throws ObjectDecayed
     {
        ...
        if (rp < 1.0){
          ...
          // + " epoch elts sub-orbital ***\n");
            throw new ObjectDecayed("SGP4.initl Fatal SGP4 error [satn: " + satn
                    + " epoch elts sub-orbital]");
        }
     ...
     */
    public OrbitalData runSgp4(String card1, String card2, int startYear, double startDay)
            throws SatElsetException {
     ...
     * @param stopDay
     * @param step
     * @return Vector of OrbitalData elements
     */
    public Vector<OrbitalData> runSgp4(String card1, String card2, int startYear,
        ...
        Vector<OrbitalData> sgp4Results = new Vector<OrbitalData>();
     ...
     *
     ----------------------------------------------------------------------------*/
    public OrbitalData sgp4() throws ObjectDecayed {
        ...
        if (nm <= 0.0)
        {
            ...
            // nm+"]");
            throw new ObjectDecayed("SGP4.sgp4 ERROR mean motion is less than zero [nm: " + nm+"]");
        }
        ...
        if ((em >= 1.0) || (em < -0.001) || (am < 0.95))
        {
          ...
          // " [em: " + em+"] [am: "+am+"]");
            throw new ObjectDecayed("SGP4.sgp4 ERROR eccentricity out of bounds"+
                    " [em: " + em+"] [am: "+am+"]");
        }
        ...
        if (satrec.nevalues.method == 2) {
            ...
            if ((satrec.ep < 0.0) || (satrec.ep > 1.0))
            {
              // System.out.println("ERROR eccentricity out of bounds [ep: " +
                // satrec.ep+"]");
                satrec.error = 3;
                throw new ObjectDecayed("SGP4.sgp4 ERROR eccentricity out of bounds [ep: " + satrec.ep+"]");
            }
        }
        ...
        if (pl < 0.0) {
           ...
           // System.out.println("FATAL Error [pl: "+ pl+"]");
            satrec.error = 4;
            throw new ObjectDecayed("SGP4.sgp4 ERROR [pl: "+ pl+"]");
        } else {
            rl = am * (1.0 - ecose);
        ...
        if (satrec.error > 0) {
          ...
          // satrec.nevalues.t, satrec.error);
            ...
            if (satrec.error == 4) {
                // no data generated
                throw new ObjectDecayed("SGP4.sgp4 Fatal SGP4 error [pl: "+ pl+"]");
            }
        }
        ...
        OrbitalData data = new OrbitalData(satrec.satnum);
     ...
     * @return OrbitalData
     */
    public OrbitalData twoline2rv(SatElset satElset) throws ObjectDecayed {
     ...
     * @return OrbitalData
     */
    public OrbitalData twoline2rv(String card1, String card2)
            throws SatElsetException, ObjectDecayed {
